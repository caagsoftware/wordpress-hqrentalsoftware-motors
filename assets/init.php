...
function hq_register_assets()
{
    ...
    wp_register_script('datetime-picker-js', plugins_url( 'js/jquery.datetimepicker.full.min.js', __FILE__ ), array('jquery'), '0.1', true );
    wp_register_script('hq-motors-js', plugins_url( 'js/hq-motors-app.js', __FILE__ ), array('jquery'), '0.1.2', true);
    wp_register_script('hq-motors-reservations-brands-js', plugins_url( 'js/hq-motor-reservations-brands.js', __FILE__ ), array('jquery'), '0.0.1', true);
